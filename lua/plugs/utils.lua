return {
    ...
    },
    {
        ...
        config = true,
        keys = {
            { '<A-left>',      function() require('smart-splits').resize_left() end,       desc = "smart-splits - resize left" },
            { '<A-down>',      function() require('smart-splits').resize_down() end,       desc = "smart-splits - resize down" },
            { '<A-up>',      function() require('smart-splits').resize_up() end,         desc = "smart-splits - resize up" },
            { '<A-right>',      function() require('smart-splits').resize_right() end,      desc = "smart-splits - resize right" },
