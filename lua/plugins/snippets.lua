return {
    {
        ...
        config = function()
            ...
            vim.keymap.set('i', '<A-j>', '<cmd>call v:lua.luasnip_map_forward()<cr>')
            vim.keymap.set('s', '<A-j>', '<cmd>call v:lua.luasnip_map_forward()<cr>')
            vim.keymap.set('i', '<A-k>', '<cmd>call v:lua.luasnip_map_backward()<cr>')
            vim.keymap.set('s', '<A-k>', '<cmd>call v:lua.luasnip_map_backward()<cr>')
