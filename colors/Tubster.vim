...
hi Visual  guifg=NONE guibg=#293b68 gui=NONE
...
hi PmenuSel  guifg=NONE guibg=#293b68 gui=NONE
...
hi Folded  guifg=#787878 guibg=#232323 gui=NONE
...
hi Label  guifg=#6fb13c guibg=#2c2c2c gui=NONE
...
hi String  guifg=#6fb13c guibg=#2c2c2c gui=NONE
hi Tag  guifg=#ffcc33 guibg=NONE gui=NONE
hi Title  guifg=#e6e1dc guibg=NONE gui=bold
hi Todo  guifg=#787878 guibg=NONE gui=inverse,bold,italic
...
hi rubyStringDelimiter  guifg=#6fb13c guibg=#2c2c2c gui=NONE
hi rubyBlockParameter  guifg=#85c5bb guibg=NONE gui=NONE
...
hi rubyRegexp  guifg=#6fb13c guibg=#2c2c2c gui=NONE
hi rubyRegexpDelimiter  guifg=#6fb13c guibg=#2c2c2c gui=NONE
...
hi erubyComment  guifg=#787878 guibg=NONE gui=italic
...
hi yamlDocumentHeader  guifg=#6fb13c guibg=#2c2c2c gui=NONE
hi cssURL  guifg=#85c5bb guibg=NONE gui=NONE
...
hi pythonFunction guifg=#da4938 guibg=NONE gui=NONE
