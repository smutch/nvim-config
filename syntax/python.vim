...
" Added by S. Mutch (23/06/11)
" Stop highlighting being messed up by colons...
set iskeyword-=:
...
" Added by S. Mutch (10/05/11) to highlight function calls
" Don't forget to add a highlight color in your colorscheme file...
syn match    pythonCustomParen    "(" contains=pythonParen
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonCustomFunc   Function
